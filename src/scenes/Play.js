class Play extends Phaser.Scene{ //Menu class becomes a child of Phaser.Scene
    ...
    create() {
        ...
        // add small ship
        this.shipSmall = new Spaceship(this, game.config.width + borderUISize*8, borderUISize*3, 'smallship', 0, 50).setOrigin(0, 0)
        ...
        this.clock = this.time.delayedCall(game.settings.gameTimer / 5, () => {
